...
![Portfolio Preview](https://img.shields.io/badge/Status-Live-brightgreen) ![React](https://img.shields.io/badge/React-18+-blue) ![Responsive](https://img.shields.io/badge/Design-Responsive-orange) ![Performance](https://img.shields.io/badge/Performance-Optimized-green)
...
- **Compelling Tagline**: "I write bugs so I can fix them!" 😄
...
- 🎓 Second-year B.Tech student specializing in Android development
- 📱 Passionate about Kotlin and Jetpack Compose
- 🌐 Exploring frontend technologies (React, Tailwind CSS)
- ☁️ Cloud computing enthusiast with AWS experience
- 💡 Always eager to learn and build creative solutions
